...
public class BatalhaTest {
    ...
    public void aoIniciarSaintUmDeMenorCategoriaPerdeVida() throws Exception {
        BronzeSaint milo = new BronzeSaint("Milo", new Armadura(new Constelacao("Escorpião"), Categoria.BRONZE));
        GoldSaint ares = new GoldSaint("Ares", new Armadura(new Constelacao("Touro"), Categoria.OURO));
        Batalha epicBattle = new Batalha(milo, ares);
        epicBattle.iniciar();
